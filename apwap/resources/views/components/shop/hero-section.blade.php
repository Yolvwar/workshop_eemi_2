    ...
    <div class="relative h-96 md:h-[450px] overflow-hidden rounded-2xl mb-6 bg-gradient-to-r from-emerald-50 via-teal-50 to-cyan-50 border border-gray-200">
        ...
        <div class="relative h-full flex items-center justify-between px-8 md:px-16">
            ...
            <div class="text-gray-900 max-w-xl">
                <div class="inline-block bg-red-500 text-white px-4 py-2 rounded-full text-sm font-bold mb-4 animate-pulse flex items-center gap-2">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <button class="bg-emerald-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-emerald-700 transition-colors shadow-lg flex items-center justify-center gap-2">
                        <x-heroicon-o-shopping-bag class="w-5 h-5" />
                        PROFITER MAINTENANT
                    </button>
                    <button class="border-2 border-emerald-600 text-emerald-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-emerald-50 transition-colors flex items-center justify-center gap-2">
                ...
                <div class="w-80 h-80 relative">
                    ...
                    <div class="absolute top-8 left-8 w-64 h-64 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center shadow-xl border border-emerald-200">
                        <div class="text-6xl flex gap-4">
                            <x-heroicon-o-face-smile class="w-16 h-16 text-emerald-600" />
                            <x-heroicon-o-heart class="w-16 h-16 text-pink-500" />
                        </div>
                    </div>
    ...
    <div class="bg-white border-2 border-red-200 p-4 rounded-xl mb-6 relative overflow-hidden shadow-lg">
        ...
        <div class="relative flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <div class="text-3xl animate-bounce flex justify-center">
                    <x-heroicon-o-bolt class="w-8 h-8 text-yellow-500" />
                </div>
                <div>
